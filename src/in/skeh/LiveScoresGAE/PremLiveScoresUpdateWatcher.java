...
public class PremLiveScoresUpdateWatcher extends UpdateWatcherServlet {
	final static String CACHE_KEY = "prem-live-scores-hash";
	...
	protected Serializable getData() {
		try {
			return (Serializable) LiveScores.getLiveMatches(Jsoup.connect(LiveScores.SCORES_URL).get()).toString();
		} catch (IOException e) {
